...
import { difficulty } from 'src/app/encounter/encounter/encounter.model';
...
export class CampaignService {
  campaigns: Campaign[] = [
    ...
    {id: 4, name: 'Campaign4', creator: {id: 1, username: 'User1', password: "password123", favorites: [], monsters: []}, party: {id: 1, name: 'Party1', size:0, campaign:'Campaign1', players: ["Jaap", "Bart"]}, encounters: [{id: 1, name: "Encounter1", creator: {id: 1, username: 'User1', password: "password123", favorites: [], monsters: []}, players: [], monsters: [], difficulty: difficulty.medium}]},
  ];
